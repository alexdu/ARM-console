...
FS["prop_register_slave"] = FSig(('property_list',hex), ('count',int), ('prop_handler',hex), ('priv',hex), ('token_handler',hex), ret=void)
...
FS["task_create"] = FSig(("name", str), ("prio", hex), ("flags", hex), ("func", None), ("arg", None), ret=None)
FS["DetectFace_InDRAM"] = FSig(None, None, None, None, None, ret=None)
FS["register_property_master"] = FSig(None, None, None, None, None, None, None, ret=None)
FS["sio3_request_maybe"] = FSig(None, None, None, None, ret=None)
FS["GetCFnData"] = FSig(None, None, ret=None)
FS["SetCFnData"] = FSig(None, None, None, ret=None)
FS["strcmp"] = FSig(str, str, ret=None)
FS["create_taskclass_msg_queue_and_task"] = FSig(None, None, None, None, None, ret=None)
FS["engio_write"] = FSig(hex, ret=None)
FS["EngDrvOut"] = FSig(hex, hex, ret=None)
FS["lvpath_copy_struct_values_from_somewhere_else"] = FSig(hex, hex, hex, ret=None)
FS["TryPostEvent"] = FSig(None, None, None, None, None, ret=void)
FS["strcpy"] = FSig(None, None, ret=void)
FS["strcpy_maybe"] = FSig(None, None, ret=void)
FS["prop_register_master"] = FSig(None, None, None, None, None, None, None, ret=void)
FS["setup_video_params"] = FSig(None, None, None, None, None, ret=void)
